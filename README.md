# Versal Gadget API [![Build Status](https://travis-ci.org/Versal/versal-gadget-api.svg?branch=master)](https://travis-ci.org/Versal/versal-gadget-api) [![Code Climate](https://codeclimate.com/github/Versal/versal-gadget-api/badges/gpa.svg)](https://codeclimate.com/github/Versal/versal-gadget-api)
...
- We have a **tutorial** to get you started, [Gadget development tutorial](https://versal.com/c/gadgets), which is a nicer version of [this file](main.md)
